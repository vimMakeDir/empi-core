 ...
 */
package com.ksyun.empi.core.algorithm.Impl;

import com.ksyun.empi.core.algorithm.BaseServiceImpl;
import com.ksyun.empi.core.algorithm.DistanceMetric;
import com.ksyun.empi.core.algorithm.DistanceMetricType;
import com.ksyun.empi.core.algorithm.StringComparisonService;
...
public class StringComparisonServiceImpl extends BaseServiceImpl implements StringComparisonService
{
	...
	private DistanceMetric getDistanceMetric(String metricTypeName) {
		...
		if (distanceMetric == null) {
			logger.error("Unknown distance metric requested: " + metricTypeName);
